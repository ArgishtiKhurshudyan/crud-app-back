let jwt,User,Color,Product;_a5a‍.x([["verifyToken",()=>verifyToken]]);_a5a‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_a5a‍.w("./models",[["User",["User"],function(v){User=v}],["Color",["Color"],function(v){Color=v}],["Product",["Product"],function(v){Product=v}]]);
