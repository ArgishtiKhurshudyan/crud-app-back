let Color,Product,Joi;_df9‍.x([["createColor",()=>createColor],["updateColor",()=>updateColor],["deleteColor",()=>deleteColor],["getColors",()=>getColors],["findOneColor",()=>findOneColor]]);_df9‍.w("../models",[["Color",["Color"],function(v){Color=v}],["Product",["Product"],function(v){Product=v}]]);_df9‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);
...
const colorCreate = Joi.object({
  ...
  try {
    ...
    console.log("asdasdasd", 1111111111)
  ...
  try {
    ...
    throw err
       ...
       const findOneColor = async (req, res) => {
  try {
    const {id} = req.params
