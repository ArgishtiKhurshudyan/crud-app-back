let User,Product,Color,bcrypt,createError,jwt;_c15‍.x([["register",()=>register],["login",()=>login]]);_c15‍.w("../models",[["User",["User"],function(v){User=v}],["Product",["Product"],function(v){Product=v}],["Color",["Color"],function(v){Color=v}]]);_c15‍.w("bcryptjs",[["default",["bcrypt"],function(v){bcrypt=v}]]);_c15‍.w("../utils/error",[["createError",["createError"],function(v){createError=v}]]);_c15‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
...
const generateAccessToken = (id, roles) => {
  ...
  try {
    ...
    if (!isPasswordCorrect) {
      ...
      _c15‍.g.console.log('token', token)
