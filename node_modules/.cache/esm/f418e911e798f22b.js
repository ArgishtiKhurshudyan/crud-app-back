let User,bcrypt,jwt,Joi;_e79‍.x([["register",()=>register],["login",()=>login]]);_e79‍.w("../models",[["User",["User"],function(v){User=v}]]);_e79‍.w("bcryptjs",[["default",["bcrypt"],function(v){bcrypt=v}]]);_e79‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);_e79‍.w("joi",[["default",["Joi"],function(v){Joi=v}]]);
