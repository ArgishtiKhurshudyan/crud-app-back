let Product,User,Color,Op;_006‍.x([["createProduct",()=>createProduct],["updateProduct",()=>updateProduct],["deleteProduct",()=>deleteProduct],["getProduct",()=>getProduct],["getProducts",()=>getProducts]]);_006‍.w("../models",[["Product",["Product"],function(v){Product=v}],["User",["User"],function(v){User=v}],["Color",["Color"],function(v){Color=v}]]);_006‍.w("sequelize",[["Op",["Op"],function(v){Op=v}]]);


       const createProduct = async (req, res) => {
  try {
    _006‍.g.console.log('req.user.id',req.user.id)
  ...
  try {
    const {productId} = req.params;
    _006‍.g.console.log("product", productId)
    const product = await Product.findOne({
      where: {id: productId, user_id: req.user.id},
      include: {
        model: Color,
  ...
  try {
    ...
    _006‍.g.console.log('Catch for getProducts, error:', err.message)
  }
}