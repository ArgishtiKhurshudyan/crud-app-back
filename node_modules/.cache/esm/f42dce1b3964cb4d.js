let Product,User,Color,Op;_396‍.x([["createProduct",()=>createProduct],["updateProduct",()=>updateProduct],["deleteProduct",()=>deleteProduct],["getProduct",()=>getProduct],["getProducts",()=>getProducts],["findOne",()=>findOne]]);_396‍.w("../models",[["Product",["Product"],function(v){Product=v}],["User",["User"],function(v){User=v}],["Color",["Color"],function(v){Color=v}]]);_396‍.w("sequelize",[["Op",["Op"],function(v){Op=v}]]);
  ...
  try {
    const {productId} = req.params;
    _396‍.g.console.log("product", productId)
    const product = await Product.findOne({
      where: {id: productId, user_id: req.user.id},
      include: {
        model: Color,
  ...
  try {
    _396‍.g.console.log('req.user.id', req.user.id)
