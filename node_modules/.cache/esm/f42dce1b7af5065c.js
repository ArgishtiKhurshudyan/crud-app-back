let Product,User,Color,Op;_7af‍.x([["createProduct",()=>createProduct],["updateProduct",()=>updateProduct],["deleteProduct",()=>deleteProduct],["getProduct",()=>getProduct],["getProducts",()=>getProducts],["findOne",()=>findOne]]);_7af‍.w("../models",[["Product",["Product"],function(v){Product=v}],["User",["User"],function(v){User=v}],["Color",["Color"],function(v){Color=v}]]);_7af‍.w("sequelize",[["Op",["Op"],function(v){Op=v}]]);
  ...
  try {
    const {productId} = req.params;
    _7af‍.g.console.log("product", productId)
    const product = await Product.findOne({
      where: {id: productId, user_id: req.user.id},
      include: {
        model: Color,
  ...
  try {
    _7af‍.g.console.log('req.user.id', req.user.id)
