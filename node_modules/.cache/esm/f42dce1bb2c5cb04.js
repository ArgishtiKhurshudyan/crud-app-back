let Product,User,Color,Op;_b2c‍.x([["createProduct",()=>createProduct],["updateProduct",()=>updateProduct],["deleteProduct",()=>deleteProduct],["getProduct",()=>getProduct],["getProducts",()=>getProducts]]);_b2c‍.w("../models",[["Product",["Product"],function(v){Product=v}],["User",["User"],function(v){User=v}],["Color",["Color"],function(v){Color=v}]]);_b2c‍.w("sequelize",[["Op",["Op"],function(v){Op=v}]]);


       const createProduct = async (req, res) => {
  try {
    _b2c‍.g.console.log('req.user.id',req.user.id)
  ...
  try {
    const {productId} = req.params;
    _b2c‍.g.console.log("product", productId)
    const product = await Product.findOne({
      where: {id: productId, user_id: req.user.id},
      include: {
        model: Color,
  ...
  try {
    ...
    _b2c‍.g.console.log('Catch for getProducts, error:', err.message)
  }
}